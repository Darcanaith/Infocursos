...
namespace Infocursos.Models
{
    public class Alumno : Usuario
    {
        ...
        private List<Object[]> cursos_Estado;
        ...
        public List<object[]> Cursos_Estado { get => cursos_Estado; set => cursos_Estado = value; }
        ...
        public Alumno(int id_User, string email, string password, string user_Nombre, string user_Apellidos, string user_Descripcion, 
            ...
            Municipio municipio, List<Categoria> categorias, List<Object[]> idioma_Nivel, List<Object[]> cursos_Estado) : base(id_User, email, password, user_Nombre, user_Apellidos, user_Descripcion, user_Resumen, iMG_Perfil, telefonos)
        {
